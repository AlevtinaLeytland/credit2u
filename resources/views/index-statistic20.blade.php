...
<div class="grid-wrapper">
    ...
    <section id="page-statistic" class="section-content">
        ...
        <div class="card card-fluid">
            <div class="card-body">
                ...
                <div class="content-row">
                    <a href="#" class="btn btn-success">Создать новый график</a>
                    <a href="#" class="btn btn-success">Создать новую карту</a>
                </div>
                <table class="table table-striped">
                    <thead></thead>
                    <tbody>
                    <tr>
                        <td>График 1, Рыбным текстом называется текст, служащий для временного наполнения макета в публикациях</td>
                        <td>
                            <div class="actions">
                                <a href="#" class="icon icon-open"> </a>
                                <a href="#" class="icon icon-delete-red"> </a>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>График 2, Рыбным текстом называется текст, служащий для временного наполнения макета в публикациях</td>
                        <td>
                            <div class="actions">
                                <a href="#" class="icon icon-open"> </a>
                                <a href="#" class="icon icon-delete-red"> </a>
                    ...
                    <tr>
                        <td>Карта 1, Рыбным текстом называется текст, служащий для временного наполнения макета в публикациях</td>
                        <td>
                            <div class="actions">
                                <a href="#" class="icon icon-open"> </a>
                                <a href="#" class="icon icon-delete-red"> </a>
                    ...
                    <tr>
                        <td>Карта 2, Рыбным текстом называется текст, служащий для временного наполнения макета в публикациях</td>
                        <td>
                            <div class="actions">
                                <a href="#" class="icon icon-open"> </a>
                                <a href="#" class="icon icon-delete-red"> </a>
                    ...
                    <tr>
                        <td>График 3, Рыбным текстом называется текст, служащий для временного наполнения макета в публикациях</td>
                        <td>
                            <div class="actions">
                                <a href="#" class="icon icon-open"> </a>
                                <a href="#" class="icon icon-delete-red"> </a>
                    ...
                    <tr>
                        <td>График 4, Рыбным текстом называется текст, служащий для временного наполнения макета в публикациях</td>
                        <td>
                            <div class="actions">
                                <a href="#" class="icon icon-open"> </a>
                                <a href="#" class="icon icon-delete-red"> </a>
                    ...
                    <tr>
                        <td>График 5, Рыбным текстом называется текст, служащий для временного наполнения макета в публикациях</td>
                        <td>
                            <div class="actions">
                                <a href="#" class="icon icon-open"> </a>
                                <a href="#" class="icon icon-delete-red"> </a>
                    ...
                    <tr>
                        <td>Карта 3, Рыбным текстом называется текст, служащий для временного наполнения макета в публикациях</td>
                        <td>
                            <div class="actions">
                                <a href="#" class="icon icon-open"> </a>
                                <a href="#" class="icon icon-delete-red"> </a>
